...
export const INDIAN_AIRPORTS: Airport[] = [
  ...
  { code: "DHM", name: "Dharamshala Airport", city: "Dharamshala", state: "Himachal Pradesh", lat: 32.16, lon: 76.26 },
  ...
  { code: "IXZ", name: "Port Blair Airport", city: "Port Blair", state: "Andaman and Nicobar", lat: 11.64, lon: 92.72 },
  ...
  { code: "TRZ", name: "Tiruchirappalli Airport", city: "Tiruchirappalli", state: "Tamil Nadu", lat: 10.76, lon: 78.7 },
  { code: "TIR", name: "Tirupati Airport", city: "Tirupati", state: "Andhra Pradesh", lat: 13.63, lon: 79.54 },
  { code: "TRV", name: "Thiruvananthapuram Airport", city: "Thiruvananthapuram", state: "Kerala", lat: 8.48, lon: 76.92 },
  ...
  { code: "VTZ", name: "Visakhapatnam Airport", city: "Visakhapatnam", state: "Andhra Pradesh", lat: 17.72, lon: 83.22 },
].sort((a, b) => a.city.localeCompare(b.city))

export function getAirportByCode(code: string) {
  return INDIAN_AIRPORTS.find((airport) => airport.code === code)
}
